...
int main(int argc, char** argv)
{
	...
	Mat img_object = imread(basePath2+"chair2.jpg");
	Mat img_scene = imread(basePath2+"scene2.jpg");
	...
	if (!img_object_gray.data || !img_scene_gray.data)
	{
	...
	Mat disp_img;
	resize(img_scene, disp_img, Size(640, 480));
	imshow("Good Matches & Object detection", disp_img);
